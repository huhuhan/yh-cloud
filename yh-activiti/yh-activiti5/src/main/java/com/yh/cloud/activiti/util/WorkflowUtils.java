package com.yh.cloud.activiti.util;
...
public class WorkflowUtils {
    ...
    public static int pageParam2(int pageNum, int pageSize) {
        /**
         * sql语句： limit pA offset pB
         * 参数1：跳过数量，即pageNum*pageSize
         * 参数2：获取数量， 即pageSize
         * 吐槽：传参1用于offset，正常应该用传参2才对，被坑了2次
         */
